...
server.get('/setLivingRoomData', function(res,req){
    console.log("Aduino will send Data");
...
/*
server.get('/setFire', function(res,req){
    fireObject.setData(res,req);
});
server.get('/setGas', function(res,req){
    gasObject.setData(res,req);
});
server.get('/setLight', function(res,req){
    lightObject.setData(res,req);
});
server.get('/setNoise', function(res,req){
    noiseObject.setData(res,req);
});
